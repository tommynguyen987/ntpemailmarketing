    ...
    public class AmazonSESWrapper
    {
        ...
        public AmazonSentEmailResult SendEmail(string awsAccessKey, string awsSecretKey, List<string> to, List<string> cc, List<string> bcc, string senderEmailAddress, string replyToEmailAddress, string subject, string body)
        {
            ...
            try
            {
                ...
                mailObj.ReplyToAddresses = new List<string> { replyToEmailAddress };
        ...
        public void SendAwsSes(MailMessage msg)
        {
        ...
        public bool AwsSesQuotaExceeded()
        {
            var client = new Amazon.SimpleEmail.AmazonSimpleEmailServiceClient(AWSAccessKey, AWSSecretKey);
            var resp = client.GetSendQuota(new GetSendQuotaRequest());
            int sendingQuota = (int)(resp.GetSendQuotaResult.Max24HourSend - resp.GetSendQuotaResult.SentLast24Hours);
            return sendingQuota <= 0;
        }
        ...
        public Amazon.SimpleEmail.AmazonSimpleEmailServiceClient CreateAmazonSDKClient(string awsAccessKey, string awsSecretKey)
        {
            ...
            if (!string.IsNullOrEmpty(awsAccessKey) && !string.IsNullOrEmpty(AWSSecretKey))
            {
                client = new Amazon.SimpleEmail.AmazonSimpleEmailServiceClient(awsAccessKey, awsSecretKey);
                    //, new Amazon.SimpleEmail.AmazonSimpleEmailServiceConfig() { ServiceURL= "https://email-smtp.us-west-2.amazonaws.com" });
            }
